#!/usr/bin/env python3
"""Compile and run telemetry_counter window-close simulation."""
...
REPORT_JSON = PROJECT_ROOT / "reports" / "telemetry_counter_sim_summary.json"
REPORT_MD = PROJECT_ROOT / "reports" / "telemetry_counter_sim_summary.md"
REPORT_LOG = PROJECT_ROOT / "reports" / "telemetry_counter_sim.log"
...
def write_summary(
    *,
    ...
    lines = [
        "# telemetry_counter Simulation Summary",
        "",
...
def main() -> int:
    compile_cmd = [
        ...
        "-Wall",
        "-o",
        "sim/build/tb_telemetry_counter_window.vvp",
        "sim/tb_telemetry_counter_window.sv",
        "rtl/telemetry_counter.v",
    ]
    run_cmd = ["vvp", "sim/build/tb_telemetry_counter_window.vvp"]
    ...
    out = build_dir / "tb_telemetry_counter_window.vvp"
    ...
    passed = (
        ...
        and "TB_PASS tb_telemetry_counter_window" in run_proc.stdout
    )
    write_summary(
        passed=passed,
