...
REPORT_LOG = PROJECT_ROOT / "reports" / "packer_axis_sim.log"
...
def main() -> int:
    compile_cmd = [
        ...
        "-Wall",
        "-o",
        "sim/build/tb_packer_axis_stall.vvp",
        "sim/tb_packer_axis_stall.sv",
        "rtl/packer_axis.v",
    ]
    run_cmd = ["vvp", "sim/build/tb_packer_axis_stall.vvp"]
    ...
    passed = (
        ...
        and "TB_PASS tb_packer_axis_stall" in run_proc.stdout
    )
    write_summary(
        passed=passed,
