...
REPORT_LOG = PROJECT_ROOT / "reports" / "safety_monitor_sim.log"
...
def main() -> int:
    compile_cmd = [
        ...
        "-Wall",
        "-o",
        "sim/build/tb_safety_monitor.vvp",
        "sim/tb_safety_monitor.sv",
        "rtl/safety_monitor.v",
    ]
    run_cmd = ["vvp", "sim/build/tb_safety_monitor.vvp"]
    ...
    passed = (
        ...
        and "TB_PASS tb_safety_monitor" in run_proc.stdout
    )
    write_summary(
        passed=passed,
